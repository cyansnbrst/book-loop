...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("BOOKLOOP_DB_DSN"), "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@bookloop.net>", "SMTP sender")
